@php $heroImage = file_exists(public_path('images/hero.jpg')) ? 'images/hero.jpg' : null; @endphp

<section class="relative flex min-h-screen items-center overflow-hidden bg-navy-950 pt-28 pb-16 sm:pt-32"
    ...
    {{-- Overlays for legibility + brand glow --}}
    <div class="absolute inset-0 -z-10 bg-gradient-to-b from-navy-950/85 via-navy-950/70 to-navy-950"></div>
    <div class="absolute inset-0 -z-10 bg-[radial-gradient(60%_50%_at_80%_10%,rgba(14,165,233,0.28),transparent)]"></div>
